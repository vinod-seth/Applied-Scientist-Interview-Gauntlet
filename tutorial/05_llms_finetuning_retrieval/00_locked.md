# 🔒 Session 5 — LLMs, Fine-Tuning & Retrieval (Locked)

| | |
|---|---|
| **Status** | Locked — not yet generated |
| **Unlocks after** | Passing the Session 4 assessment |
| **Targets** | Your nlp/llm specialization claims |

## 🟢 What This Session Will Cover

The PEFT landscape beyond LoRA, decoding and sampling strategies, scaling behavior, RAG design space, evaluating LLM systems.
