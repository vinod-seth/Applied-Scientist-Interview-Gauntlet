# 🔒 Session 9 — Mock Loop & Integration (Locked)

| | |
|---|---|
| **Status** | Locked — not yet generated |
| **Unlocks after** | Clearing the Session 8 boss fight |
| **Targets** | The complete gauntlet, end to end |

## 🟢 What This Session Will Cover

A full simulated 4-round loop, round-playbook execution, the cumulative final assessment, and the capstone with self-assessment rubric.

## 🟢 How to Unlock

1. Reach **Gold** on all of Session 8's core topics and clear its boss fight.
