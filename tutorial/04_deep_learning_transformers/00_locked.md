# 🔒 Session 4 — ML Fundamentals: Deep Learning & Transformers (Locked)

| | |
|---|---|
| **Status** | Locked — not yet generated |
| **Unlocks after** | Passing the Session 3 assessment |
| **Targets** | Deep-learning breadth at derivation depth |

## 🟢 What This Session Will Cover

Backprop mechanics, the normalization family, attention variants (MHA/MQA/GQA), training pathologies and their fixes.

## 🟢 How to Unlock

1. Work through Session 3's core topics until you can defend each one, and run its mock round.
